...
public class ThemeContent {
    ...
    public static ThemeContent objectFromData(String str) {
        return new Gson().fromJson(str, ThemeContent.class);
    }

    public static ThemeContent objectFromData(String str, String key) {
        try {
            JSONObject jsonObject = new JSONObject(str);
            return new Gson().fromJson(jsonObject.getString(str), ThemeContent.class);
