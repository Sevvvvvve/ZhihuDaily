...
public class Themes {
    ...
    private List<Theme> mSubscribed;

    @SerializedName("others")
    private List<Theme> mThemes;

    public static Themes objectFromData(String str) {
        return new Gson().fromJson(str, Themes.class);
    }

    public static Themes objectFromData(String str, String key) {
        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), Themes.class);
