...
public class Paper {
    ...
    public static Paper objectFromData(String str) {
        return new Gson().fromJson(str, Paper.class);
    }

    public static Paper objectFromData(String str, String key) {
        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), Paper.class);
    ...
    public static Paper create(String date, @NonNull List<Story> stories) {
    ...
    public static Paper create(@NonNull List<Story> stories) {
        return create(stories.get(0).getDate(), stories);
    }
